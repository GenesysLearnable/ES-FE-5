...
function App() {
  return (
    <div className="App">
      ...
      <a href="/Home"><img src={saveme}  alt="Home Logo"  /></a>
      ...
      <section className="cards">
        ...
        <div className="card">
          ...
          <p>We are here to help.</p><br/>
          <h3>See document</h3>
        </div>

        <div className="card">
          <img src="src/contactpage/chat.png" alt="Chat Icon" /><br/>
         <br/>
         ...
         <div className="card">
          ...
          <br/>
         <p><a href="#maps">View on Google Maps</a></p>
        </div>
