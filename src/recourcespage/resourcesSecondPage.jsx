      ...
      <section>
        <div className="location-quick-section">
          ...
          <div className="ResourcesFirstPage-1">
            ...
            <p>Mouth-to-mouth resuscitation is an emergency first aid technique used to help someone who is not breathing or is unconscious. It involves blowing air into their lungs to keep them oxygenated.</p>
            <br />
            <p>Here are the steps for mouth-to-mouth resuscitation:</p>
            <br />
            <p>1. Check the scene: Make sure it's safe for you and the person needing help.</p>
            <br />
            <p>2. Check for responsiveness: Gently tap or shake the person and ask if they are okay. If they don't respond, they need help.</p>
            <br />
            <p>3. Open the airway: Tilt their head back slightly and lift their chin to open the airway.</p>
            <br />
            <p> 4. Check for breathing: Look, listen, and feel for breathing for about 5-10 seconds. If they are not breathing normally, proceed with rescue breaths.</p>
            <br />
            <p>5. Give rescue breaths: <br /> - Pinch the person's nose shut. <br /> - Take a normal breath and make a tight seal over their mouth. <br /> - Blow steadily into their mouth for about 1 second, watching for their chest to rise. <br /> - Repeat this process to give 2 rescue breaths.</p>
            <br />
            <p>6. Check for pulse: If you don't feel a pulse, start CPR. If you feel a pulse but no normal breathing, continue rescue breaths.</p>
            <br />
            <p>These steps are meant to keep oxygen flowing into the person's lungs until professional medical help arrives. Practice and training in first aid are valuable skills to have in emergencies.</p>
            <br />
            </div>
          </div>
        </div>
